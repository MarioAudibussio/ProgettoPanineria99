...
import com.example.schedacibo.databinding.ActivityPaniniDetailFragmentBinding
import com.squareup.picasso.Picasso

class ProductDetailActivity : AppCompatActivity() {

    // Variabile per il View Binding
    private lateinit var binding: ActivityPaniniDetailFragmentBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // Inizializza il binding
        binding = ActivityPaniniDetailFragmentBinding.inflate(layoutInflater)
